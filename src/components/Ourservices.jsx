...
const Ourservices = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center bg-gray-100  p-5">
      <div className="text-xl font-bold mb-4">Pakhre Clinic Center</div>
      <div className="text-lg mb-6">Our Trusted Dental Services for you</div>
      <div className="grid grid-cols-2 md:grid-cols-6 gap-4 md:gap-6 w-full md:w-1/2 px-4 ">
        {services.map((service, index) => (
          <div
            ...
            className="flex flex-col justify-center items-center bg-white shadow-lg rounded-lg p-4"
          >
            <img
              src={service.image}
              alt={service.title}
